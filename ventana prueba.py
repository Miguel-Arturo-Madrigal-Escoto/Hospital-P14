        ...
        for y in leer_lineas_dos:
            if cont >= contador_lineas and cont <= limite:
                if mostrar == 0:
                    ...
                    if encontrado == 0:
                        print(Fore.WHITE+Cursor.POS(18,15+posicion)+"El medico aun no tiene pacientes")
                    else:
...
def modificar_servicio_f(e=[''],f=['']):
    ...
    for validar in e:
        try:
            ...
            ventana(86, 92, 8, 40, 86, 40,8, 0,"")
            ventana(18, 92, 40, 40, 18, 35,35, 0,"")
            modificar_servicio = str(input(Fore.CYAN+Cursor.POS(18,8)+"Servicio a reemplazar: "))
            if modificar_servicio.upper()+"\n" not in aux_dos and modificar_servicio.upper() not in aux_dos:
                ...
                for validar_dos in f:
                    ...
                    try:
                        print(Cursor.POS(40,6)+Fore.CYAN+"MODIFICAR SERVICIO")
                        reemplazar_servicio = str(input(Fore.CYAN+Cursor.POS(18,10)+"Nuevo servicio: "))
                        ...
                        if reemplazar_servicio_dos.isalpha() and reemplazar_servicio.upper()+"\n" not in aux_dos:
                            for line_dos in leer1:
                                if line_dos != modificar_servicio.upper()+"\n" and line_dos != modificar_servicio.upper():
                                    archivo_datos.write(line_dos)
                                    os.system("cls")
                                else:
                                    archivo_datos.write(line_dos.replace(modificar_servicio.upper()+"\n",reemplazar_servicio.upper()+"\n"))
                                    os.system("cls")
...
def eliminar_servicio(contador3,c=[""]):
    ...
    for validar in c:
        ...
        try:
            eliminar_servicio = str(input(Fore.CYAN+Cursor.POS(18,8)+"Servicio a eliminar: "))
    ...
    for val in g:
        ...
        try:
            ...
            if nuevos_servicios.upper()+"\n" not in aux_cuatro and nuevos_servicios.upper() not in aux_cuatro and nuevos_servicios_dos.isalpha():
                if contador3 == 0 and cont_lineas == 2:
                    archivo_datos.write(nuevos_servicios.upper())
                else:
            ...
            g.append("")
    g.clear();g.append("")
    lista_cuatro.clear();aux_cuatro.clear()
    archivo_datos.close()
    contador3+=1
    os.system("cls")
